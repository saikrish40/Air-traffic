...
print('Probability of getting Clogging for the data set:1,1,1,1,1,1,1,1,1 is:', result)
to_predict = np.array([1, 0, 0, 1, 0, 0, 0, 1])
result = sigmoid(np.dot(to_predict, weights) + bias)
print('Probability of getting Clogging for the data set:1,0,0,1,0,0,0,1 is:', result)
to_predict = np.array([1, 0, 1, 0, 1, 1, 1, 1])
result = sigmoid(np.dot(to_predict, weights) + bias)
print('Probability of getting Clogging for the data set:1,0,1,0,1,1,1,1 is:', result)
